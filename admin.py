...
#--- conecion con la base de daros -----
with sqlite3.connect("./Database/store.db") as db:
    cur = db.cursor()
# genera codigo de empleado
...
def exitt():
    ...
    if sure == True:
        adm.destroy()
        root.destroy()
#---FUNCION DE LLAMAR ALA VENTANA INVENTARIO ....
def inventory():
    adm.withdraw()
    global inv
    global page3
    ...
    inv.mainloop()
#----FUNCION DE LLAMR ALA VENTANA EMPLEADO----
...
#-------BOTON PARA ABRIR VENTANA INVENTARIO ----
...
# CREAMOS CUADRO DE REGISTRO DE PRODUCTO 
