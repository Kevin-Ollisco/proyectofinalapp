...
# ----------- numero de contacto en factura
def valid_phone(phn):
    if re.match(r"[678]\d{7}$", phn):
        return True
    return False
#--- VERIFICACION DE LA CUENTA DE EMPLEADO 
...
class login_page:
    ...
    def __init__(self, top=None):
      ...
      #-------IMPORTAMOS EL DISEÑO DEL MODO CAJERO
